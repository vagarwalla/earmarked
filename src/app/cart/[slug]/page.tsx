    ...
    if (editingItem) {
      ...
      const res = await fetch(`/api/cart/${slug}/items`, {
        ...
        body: JSON.stringify({
          ...
          flexible: false,
          signed_only: cart?.default_signed_only ?? false,
          first_edition_only: cart?.default_first_edition_only ?? false,
          dust_jacket_only: cart?.default_dust_jacket_only ?? false,
          quantity: 1,
